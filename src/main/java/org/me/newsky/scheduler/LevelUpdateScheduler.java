...
public class LevelUpdateScheduler {
    ...
    public void start() {
        updateTask = plugin.getServer().getScheduler().runTaskTimerAsynchronously(plugin, this::updateIslandLevels, 0, updateInterval / 50);
    }
    ...
    private void updateIslandLevels() {
        plugin.debug("Starting scheduled task to update island levels.");
