...
public class AdminPvpCommand implements SubCommand, AsyncTabComplete {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        api.getPlayerUuid(targetPlayerName).thenCompose(targetUuidOpt -> {
            ...
            return api.getIslandUuid(targetUuidOpt.get()).thenCompose(islandUuid -> api.toggleIslandPvp(new Actor.Bypass(sender.getName()), islandUuid)).thenAccept(isPvpEnabled -> {
                if (isPvpEnabled) {
